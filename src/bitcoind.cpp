...
void ThreadCli()
{
    ...
    printf("TogetherChain CLI ready:\n> ");
    fflush(stdout);
...
void WaitForShutdown(boost::thread_group* threadGroup)
{
    ...
    LogPrintf("TogetherChain shutdown.\n\n");
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to TogetherChaind / RPC client
            std::string strUsage = _("TogetherChain version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  TogetherChaind [options]                     " + "\n" +
                  "  TogetherChaind [options] <command> [params]  " + _("Send command to -server or TogetherChaind") + "\n" +
                  "  TogetherChaind [options] help                " + _("List commands") + "\n" +
                  "  TogetherChaind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "TogetherChain:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect TogetherChaind signal handlers
    noui_connect();
