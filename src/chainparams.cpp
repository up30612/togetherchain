...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "7/15,2016. The TogetherChain released, www.TogetherChain.org";
        CTransaction txNew;
        ...
        genesis.nTime    = GENESIS_BLOCK_TIME;
             ...
             vSeeds.push_back(CDNSSeedData("60.205.200.138",  "60.205.200.138"));
		vSeeds.push_back(CDNSSeedData("47.52.43.74",  "47.52.43.74"));
...
public:
    CMainParams() {
      ...
      //  nLastPOWBlock = std::numeric_limits<int>::max();
        ...
        nFirstPosv2Block = 100000000;
        nFirstPosv3Block = 100000000;
        ...
        genesis.nNonce   = 167435;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x5274a253aebf25ae0b5567684f9345bfe0988c96ebfff6de76dbae9327fd7415"));
        assert(genesis.hashMerkleRoot == uint256("0xe4d8265db3bc72777dc821affa61c7c766d9e9a76d91a91c705741442fa67475"));
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xe0edfac5a26df46708d9c9dac79d3015e776f9e66b71e8f49b9e60ca3feffd7c"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x802ed2cd82cae73971ee37438294e1e55b540e318dc1301cbf7fbf5ed7dabd86"));
